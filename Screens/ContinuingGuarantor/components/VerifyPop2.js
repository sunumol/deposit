...
const Verifypop2 = ({ ModalVisible, onPressOut, setModalVisible, navigation }) => {
        ...
        >
            <View style={styles.mainContainer} >
                ...
                <View style={styles.modalContainer}>
                    ...
                    <Text style={[styles.textdesc, { paddingTop: width * 0.04, textAlign: 'center' }]}>Could not verify please enter all data
                    </Text>
                    <View style={{ flexDirection: 'row', justifyContent: 'space-between', paddingTop: 22, paddingBottom: 22 }}>
                        ...
                        <TouchableOpacity style={styles.ButtonContinue}  onPress={() => setModalVisible(false)}>
                            <Text style={styles.textC}>Okay</Text>
                        </TouchableOpacity>
                    </View>
                </View>
                <TouchableOpacity
