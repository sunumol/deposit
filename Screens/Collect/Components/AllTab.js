          ...
          <>
            <View style={styles.ViewCard}>
                ...
                <View
                  ...
                  <View
                    ...
                    <Text style={styles.AmtText}>
                      ₹{pendingdata?.amountsDue ? pendingdata?.amountsDue : 0}
                    </Text>
                  </View>
                </View>
              </View>
              ...
              <View
                ...
                <View
                  style={{flexDirection: 'column', paddingLeft: width * 0.03}}>
                  <Text style={styles.TextCust}>Loans Due</Text>
                  <Text style={styles.NumText}>
                    {pendingdata?.loansDue ? pendingdata?.loansDue : 0}
                  </Text>
                </View>
              </View>
            </View>
          ...
          {sortcondition ?  <View style={{flex: 1, marginRight: 20, alignItems: 'flex-end'}}>
              <TouchableOpacity
                ...
                style={{
                  padding: 5,
                  marginTop: 10,
                  backgroundColor: 'rgba(229, 231, 250, 1)',
                  borderRadius: 5,
                  justifyContent: 'center',
                  alignItems: 'center',
                }}>
            ...
            <CustomDetails
              ...
              details={pendingdata?.pendingCustomerCollectionResponses}
            />
          </>
        )}
