...
import { BorderBottom } from "react-native-unicons";
                ...
                <View style={styles.centeredView2}>
                    <View style={styles.modalView}>
                        <View style={{
                            ...
                            paddingLeft: width * 0.06, paddingRight: width * 0.06, alignItems: 'center', borderBottomWidth: 1, paddingVertical: width * 0.04, borderBottomColor: '#ECEBED'
                        }}>
