...
const Retryuploadimage = ({ ModalVisible, onPressOut,onPress1 }) => {
            ...
            <View style={styles.mainContainer} >
                ...
                <View style={styles.modalContainer}>
                    ...
                    <View style={{ paddingTop: width * 0.02,paddingHorizontal: width *0.05 }}>
                        ...
                        <Text style={styles.textdesc}>Could not upload photo. Please try again</Text>
...
export default Retryuploadimage;