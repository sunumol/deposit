...
import { Dimensions, Modal, StyleSheet, Text, TouchableOpacity, View, TextInput } from "react-native";
...
const EditAddModal = ({ ModalVisible, onPressOut, onPress1, navigation, Address, setAddress, custID, setModalVisible }) => {
    ...
    useEffect(() => {
        if (Address1 !== Address1) {
            setAddress1(Address)
            console.log("address daat useeF")
        }
    }, [Address1])
    ...
    const EditAddress = (lang) => {
        console.log("inside api", lang);
        const data = {
            "customerId": custID,
            "address": Address
        }
                ...
                <View style={styles.modalContainer}>
                    <View>
                        <View style={{ alignItems: 'center' }}>
                            <Text style={styles.nameText}>Aadhaar Address</Text>
                        </View>
                        <View style={{
                            alignItems: 'center',
                            ...
                            <View style={{ alignItems: 'center', justifyContent: 'center', marginBottom: 5, marginTop: 5 }}>
                                ...
                                { backgroundColor: Address ? COLORS.colorB : '#ECEBED' }]}
                                    onPress={() => { EditAddress() }}
                                >

                                    <Text style={[styles.text1, { color: Address ? COLORS.colorBackground : '#979C9E', paddingLeft: width * 0.02 }]}>Submit</Text>
                                </TouchableOpacity>
                            </View>
                        </View></View>
                </View>
