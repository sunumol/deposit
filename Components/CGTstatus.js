...
const CGTstatus = ({ ModalVisible, onPressOut, setModalVisible, navigation ,Press,Press1}) => {
        ...
        >
            <View style={styles.mainContainer} >
                ...
                <Text style={[styles.textdesc, { paddingTop: width * 0.01, textAlign: 'center',fontSize:20,fontWeight:'bold' }]}>Unsaved Changes
                    ...
                    <Text style={[styles.textdesc, { paddingTop: width * 0.05, textAlign: 'center' }]}>Do you want to save or discard them
                    </Text>
                    <View style={{ flexDirection: 'row', justifyContent: 'space-between', paddingTop: 22, paddingBottom: 5,alignItems:'center' }}>


                    <TouchableOpacity style={[styles.ButtonCancel, { marginRight: 10 }]} onPress={() => {Press1()}}>
                            <Text style={styles.text2}>Discard</Text>
                        </TouchableOpacity>
                        <TouchableOpacity style={[styles.ButtonContinue, { }]} onPress={() => {Press()}}>
