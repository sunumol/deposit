...
const ModalSchedule = ({ ModalVisible, onPressOut, setModalVisible, navigation }) => {
        ...
        >
            <View style={styles.mainContainer} >
                ...
                <View style={styles.modalContainer}>
                    ...
                    <Text style={[styles.textdesc, { paddingTop: 26, textAlign: 'center' }]}>Do you want to cancel the CGT process ?
                    </Text>
                    <View style={{ flexDirection: 'row', justifyContent: 'space-between', paddingTop: 18, paddingBottom: 22 }}>
                        ...
                        <TouchableOpacity style={styles.ButtonCancel} onPress={() => navigation.navigate('ActivityScreens')}>
