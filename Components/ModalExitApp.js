...
const ModalExit = ({ ModalVisible, onPressOut, setModalExitAppVisible }) => {
        ...
        >
            <View style={styles.mainContainer} >
                ...
                <View style={styles.modalContainer}>
                    ...
                    <Text style={[styles.textdesc, { paddingTop: width * 0.04, textAlign: 'center', fontSize: Lang == 'en' ? 14 : 14 }]}>{t('common:ExitModal')}
                    </Text>
                    <View style={{ flexDirection: 'row', justifyContent: 'space-between', paddingTop: 22, paddingBottom: 22 }}>
                        <TouchableOpacity style={[styles.ButtonCancel, { marginRight: 10 }]} 
                        onPress={() => {
                            setModalExitAppVisible(false)
                            BackHandler.exitApp()
                        }}
                        >
                        ...
                        <TouchableOpacity style={styles.ButtonContinue} onPress={onPressOut} >
